...
# Options:
    ...
    # 1 
    # 2
    # 3 ZINDO/S (semi-empirical)
    # 4 HF 3c (semi-empirical)
# Note: A fast method should be used for the initial calculation
...
ncycles_values=(10) # Number of Simulated Annealing cycles
